    ...
    [AVCaptureDevice requestAccessForMediaType:AVMediaTypeVideo completionHandler:^(BOOL granted) {
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            if (granted) {
                ...
                if (!input) {
                    //Refactored UIAlertController
                    [self alertVC:error.localizedDescription withMessage:error.localizedRecoverySuggestion];
                } else {
                ...
                ////Refactored UIAlertController
                [self alertVC:NSLocalizedString(@"Camera Permission Denied", @"camera permission denied title") withMessage:NSLocalizedString(@"This app doesnt have permission to use the camera; please update your privacy settings.", @"camera permission denied recovery suggestion")];
            }
        });
    }];
...
- (UIAlertController *)alertVC:(NSString *)alertTitle withMessage:(NSString *)message{
    ...
    [alert addAction:[UIAlertAction actionWithTitle:NSLocalizedString(@"OK", @"OK button") style:UIAlertActionStyleCancel handler:^(UIAlertAction *action){
